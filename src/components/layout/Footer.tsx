    ...
    <footer className=" border-t bg-white border-gray-200 mt-auto font-sans">
      ...
      <div className="w-full mx-auto px-6 md:px-28 pt-12 md:pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-10 md:mb-16">
          ...
          {/* Contact Section - Pushed Right, but Left-Aligned content */}
  ...
  <div className="flex items-center space-x-5 pt-4">
    ...
    >
      ...
      >
        ...
        {/* Bottom Bar */}
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-8 text-center">
          <p className="text-[10px] md:text-[11px] tracking-[0.15em] text-text-muted uppercase font-semibold">

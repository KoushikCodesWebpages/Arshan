          ...
          <div className="relative flex justify-center lg:justify-end animate-in fade-in zoom-in duration-1000 mt-16 lg:mt-0">
            ...
            */}
            ...
            {/* The Floating Value Card: 
                Updated Positioning to 'absolute bottom-[-40px] left-[-30px]' (or md:-left-12 as originally proposed) 
                to precisely overlap the image as shown in the design. Increased opacity-100 for maximum clarity.
            */}
            <div className="absolute -bottom-10 -left-6 md:-left-10 bg-white p-8 rounded-xl shadow-2xl border-l-4 border-tertiary max-w-[320px] z-20 opacity-100">

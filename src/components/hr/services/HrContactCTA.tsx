  ...
  return (
    <section className="py-24 bg-background">
      <div className="container mx-auto px-6 lg:px-28">
        <FadeInStagger>
          <FadeItem>
            <div className={`relative overflow-hidden rounded-4xl p-12 lg:p-20 text-center ${theme.brand.primary} shadow-2xl`}>
              ...
              <div className="relative z-10 max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <button className={`${theme.buttons.tertiary} px-8 py-4 text-base min-w-60`}>
                    Schedule a Consultation
                  </button>

                  {/* Secondary CTA Button (Transparent/Glass) */}
                  <button className="inline-flex items-center justify-center px-8 py-4 text-sm font-semibold text-white bg-white/10 hover:bg-white/20 border border-white/10 rounded-sm transition-all active:scale-[0.98] min-w-60">
